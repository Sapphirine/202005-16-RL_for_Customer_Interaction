...
df_para = pd.read_csv(DATA_PATH.joinpath("df_parameters1.csv"))
df_it = pd.read_csv(DATA_PATH.joinpath("df_it1.csv"))
df_im = pd.read_csv(DATA_PATH.joinpath("df_im1.csv"))
