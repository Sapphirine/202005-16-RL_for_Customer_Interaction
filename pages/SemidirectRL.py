...
df_para = pd.read_csv(DATA_PATH.joinpath("df_parameters3.csv"))
df_it = pd.read_csv(DATA_PATH.joinpath("df_it3.csv"))
df_im = pd.read_csv(DATA_PATH.joinpath("df_im3.csv"))
